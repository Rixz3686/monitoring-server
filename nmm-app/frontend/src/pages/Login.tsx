...
export default function Login() {
  ...
  return (
    ...
    >
      {/* Decorative circles */}
      <div style={{ position: "absolute", top: "-100px", right: "-100px", width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(233,30,99,0.07) 0%, transparent 70%)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: "-80px", left: "-80px", width: 350, height: 350, borderRadius: "50%", background: "radial-gradient(circle, rgba(156,39,176,0.05) 0%, transparent 70%)", pointerEvents: "none" }} />
      ...
      >
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <div style={{ fontSize: "0.875rem", color: "#6b7280" }}>
            Masuk untuk memantau infrastrukturmu
          </div>
        </div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <button
            ...
            style={{
              ...
              color: "#fff", fontFamily: "'Supermercado One', sans-serif",
        ...
        <div style={{ textAlign: "center", marginTop: 24, paddingTop: 20, borderTop: "1px solid #f3f4f6" }}>
          <span style={{ fontSize: "0.875rem", color: "#6b7280" }}>Belum punya akun? </span>
          <Link to="/register" style={{ color: "#e91e63", fontWeight: 700, fontSize: "0.875rem" }}>Daftar di sini</Link>
        </div>
      </div>
